...
//    @EnvironmentObject var appSettings: AppSettings
    ...
    //@EnvironmentObject var arDrawFlags: ARDrawFlags
    //https://sarunw.com/posts/move-view-around-with-drag-gesture-in-swiftui/
    //minimumDistance solves the problem of drag in a scrollview
    ...
    var body: some View {
        ...
        //.scaledToFit()
        //hack to make it work so that it does not push the other ui down.
        //still need to match the image dimensions
        //.frame(width:389, height:524)
        //.background(Color.blue)
        //there appears to be a frame tie to a zstack
        //the size does not constraint the positioning of the view
        //https://www.hackingwithswift.com/books/ios-swiftui/absolute-positioning-for-swiftui-views
        //related to when use absolute positioning, a new view with the available space is provided
        //thus giving a frame size that puses the vstack.
        //find out the image width and height
        //https://stackoverflow.com/questions/62878362/swiftui-how-to-find-the-height-of-an-image-and-use-it-to-set-the-size-of-a-fram
